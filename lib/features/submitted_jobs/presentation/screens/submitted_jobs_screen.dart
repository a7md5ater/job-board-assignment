...
class SubmittedJobsScreen extends StatefulWidget {
  const SubmittedJobsScreen({super.key});

  @override
  State<SubmittedJobsScreen> createState() => _SubmittedJobsScreenState();
}

class _SubmittedJobsScreenState extends State<SubmittedJobsScreen> {
  @override
  void initState() {
    context.read<SubmittedJobsCubit>().getSubmittedJobs();
    super.initState();
  }
